            ...
            <div class="r-terms__inner">
                ...
                <div class="r-terms__categories">
                    <div class="r-terms__category">
                        <a class="r-terms__category-link" href="./02_repair.php">
                            <button class="r-terms__category-btn" type="button">Ремонт с дизайном со стандартным ремонтом</button>
                        </a>
                        <a class="r-terms__category-link" href="#">
                            <button class="r-terms__category-btn r-terms__category-btn-active" type="button">Ремонт без дизайна с нестандартным ремонтом</button>
                        </a>
                    </div>
                </div>
                ...
                <div class="r-terms__container">
                    ...
                    <div class="r-terms__col r-terms__col-dark">
                        ...
                        <div class="r-terms__col-num">4.5 мес</div>
                        <div class="r-terms__col-num">5 мес</div>
                        <div class="r-terms__col-num">5.5-7 мес</div>
                    </div>
                    ...
                    <div class="r-terms__col">
                        ...
                        <div class="r-terms__col-num">4.5 мес</div>
                        <div class="r-terms__col-num">5 мес</div>
                        <div class="r-terms__col-num">5.5 мес</div>
                        <div class="r-terms__col-num">6-7.5 мес</div>
                    </div>

                    <div class="r-terms__col r-terms__col-dark">
                        <p class="r-terms__col-title">Вторичное жилье</p>
                        <div class="r-terms__col-num">6.5 мес</div>
                        <div class="r-terms__col-num">7 мес</div>
                        <div class="r-terms__col-num">7.5 мес</div>
                        <div class="r-terms__col-num">8-9 мес</div>
                    </div>
                </div>
