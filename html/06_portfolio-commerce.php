        ...
        <div class="container">
            <div class="pl-intro__inner">
                ...
                <div class="pl-intro__links">
                    ...
                    <a class="pl-intro__link pl-intro__link-active" href="#">Коммерческие помещения</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="pl-works">
        <div class="container">
            <div class="pl-works__inner">
                <h2 class="pl-works__title">Наши работы по дизайну коммерческих помещений</h2>
                ...
                <div class="pl-works__button">
                    <a class="pl-works__link" href="../html/05_portfolio-living.php">
                        <button class="pl-works__btn" type="button">Жилые помещения</button>
                    </a>
                </div>
            </div>
        </div>
